...
{
	$.weeboxs.open(ROOT+'?m=Delivery&a=selectRegions', {contentType:'ajax',showButton:true,title:LANG['SELECT_SUPPORT_REGION'],width:300,height:250,onok:function(ob){
...
function switch_region(o)
{
	...
	if($.trim($(o).html())=='+')
	{
		...
		{
			$.ajax({ 
				url: ROOT+"?"+VAR_MODULE+"=Delivery&"+VAR_ACTION+"=getSubRegion&id="+region_id, 
				data: "ajax=1",
